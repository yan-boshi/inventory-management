        ...
        <div class="customer-info-row">
          <div class="customer-left">
            ...
            <div class="row">
              ...
              <span class="value address-value">{{ orderData?.customer_address || '-' }}</span>
            </div>
          </div>
...
const initializeFormData = () => {
  ...
  formData.deliveryTime = order.delivery_time || new Date().toISOString()
  formData.quantity = 0
  formData.remarks = ''
  formData.total = order.total_amount || 0
