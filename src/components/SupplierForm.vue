<template>
  ...
  >
    ...
    >
      <!-- 供应商信息 -->
      <a-divider orientation="left" style="margin: 4px 0 8px;">供应商信息</a-divider>
      <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 0 16px;">
        <a-form-item label="供应商名称" name="supplier_name" style="margin-bottom: 8px;">
          <a-input v-model:value="form.supplier_name" placeholder="请输入供应商名称" />
        </a-form-item>

        <a-form-item label="供应商代码" name="supplier_code" style="margin-bottom: 8px;">
          <a-input v-model:value="form.supplier_code" placeholder="请输入供应商代码" :disabled="isEdit" />
        </a-form-item>

        <a-form-item label="供应商税号" name="supplier_tax_number" style="margin-bottom: 8px;">
          <a-input v-model:value="form.supplier_tax_number" placeholder="请输入供应商税号" />
        </a-form-item>

        <a-form-item label="联系电话" name="supplier_phone" style="margin-bottom: 8px;">
          <a-input v-model:value="form.supplier_phone" placeholder="请输入联系电话" />
        </a-form-item>

        <a-form-item label="联系邮箱" name="supplier_email" style="margin-bottom: 8px;">
