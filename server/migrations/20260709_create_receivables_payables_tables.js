...
async function down() {
  ...
  try {
    ...
    console.log('Dropping receivables and payables tables...')
    await connection.query('DROP TABLE IF EXISTS payables')
    await connection.query('DROP TABLE IF EXISTS receivables')
